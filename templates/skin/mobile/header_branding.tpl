...
<style>
    body { background: {$oCity->getBackgroundColor()} url({$oCity->getBrandImage()}) center top no-repeat!important; display: table; width: 100%; }
    #header{ margin-bottom: 200px;}
    #footer{ background-color: #ffffff; vertical-align: bottom; clear: both; padding-top: 20px; margin-top: 30px; border-top: #ccc 1px solid;}
